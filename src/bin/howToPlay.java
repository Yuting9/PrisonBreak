...
public class howToPlay implements ActionListener
{
  ...
  howToPlay(final JFrame main)
  {
    ...
    //sets up the window title, size, and layout of frame. Also makes it visible
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    if(e.getSource() == btnNext)
    {
      ...
      //If the page number is greater than or equal to the number of pages the next button is not clickable 
